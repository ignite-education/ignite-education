-- Fix the existing user_progress table to match our API expectations
-- This migration updates the schema to use TEXT for course_id and ensures correct column names
...
CREATE TABLE user_progress (
  ...
  course_id TEXT NOT NULL,  -- Changed from UUID to TEXT to match course names
