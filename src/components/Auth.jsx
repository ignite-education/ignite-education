          ...
          width: '510px'
                    ...
                    return (
                      <div
                        ...
                        style={{ padding: '16px', filter: isBlurred ? 'blur(1px) brightness(0.7)' : 'none', transition: 'filter 100ms ease-in-out, transform 100ms ease-in-out', scrollSnapAlign: 'start' }}
