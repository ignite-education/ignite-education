              ...
              <div className="relative" style={{ marginLeft: '-50px', width: 'calc(100% + 50px)', overflow: 'visible' }}>
                <div
                  ...
                  style={{
                    ...
                    paddingRight: '300px', paddingTop: '10px', paddingBottom: '10px'
                  }}
                >
                  <style>{`
          ...
          width: '510px'
                    ...
                    return (
                      <div
                        ...
                        style={{ padding: '16px', filter: isBlurred ? 'blur(1px) brightness(0.7)' : 'none', transition: 'filter 200ms ease-out, transform 100ms ease-in-out', scrollSnapAlign: 'start' }}
