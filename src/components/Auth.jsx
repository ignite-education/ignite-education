            ...
            <div style={{ maxWidth: '70rem', paddingLeft: '4rem', paddingRight: '0rem' }} className="auth-section-5-grid mx-auto">
              <div className="grid grid-cols-2 gap-4 items-start">
                ...
                <div className="auth-testimonial-container flex flex-col justify-center"
                  ...
                  {/* Carousel Indicators */}
                  <div style={{ width: '100%', maxWidth: '36rem', marginTop: '1rem', padding: isMobile ? '0' : '0 1.5rem', display: 'flex', justifyContent: isMobile ? 'flex-start' : 'center', boxSizing: 'border-box' }}>
