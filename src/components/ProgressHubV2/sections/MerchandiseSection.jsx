...
const MerchandiseSection = () => {
  return (
    <section className="bg-white px-12 pb-8" style={{ paddingTop: '45px' }}>
      <h2 className="text-black" style={{ fontSize: '2rem', fontWeight: 600, lineHeight: '1.2', letterSpacing: '-1%', marginBottom: '0.75rem' }}>Merchandise</h2>
      ...
      <div className="flex justify-between items-center gap-3" style={{ height: '276px' }}>
        {PRODUCTS.map((product) => (
          <img
            ...
            src={product.src}
            alt={product.alt}
            className="h-full object-cover rounded transition-transform duration-200 hover:scale-[1.025] cursor-pointer min-w-0 flex-1"
