                ...
                <div className="flex gap-2 mb-2" style={{ alignItems: 'flex-start' }}>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start gap-2 mb-1" style={{ marginTop: '-4px' }}>
                      <h3 className="text-white flex-1" style={{ fontSize: '1rem', fontWeight: 500, letterSpacing: '0%' }}>{post.title}</h3>
                      <span className="text-xs text-white flex-shrink-0" style={{ marginTop: '2px' }}>{getTimeAgo(post.created_at)}</span>
                    </div>
                    <p className={`text-white mb-2 ${expandedPostId === post.id ? '' : 'line-clamp-6'}`} style={{ fontSize: '0.8rem', fontWeight: 300, letterSpacing: '0%' }}>
                      {post.content}
                    </p>
