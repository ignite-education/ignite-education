              ...
              <div className="flex-1 space-y-2.5">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    onMouseLeave={(e) => e.currentTarget.style.boxShadow = '0 0 6px rgba(103,103,103,0.35)'}
                  >
                    <span style={{ fontSize: '1rem', fontWeight: 400, letterSpacing: '-0.02em', color: isGoogleLinked ? '#22C55E' : undefined }}>{isGoogleLinked ? 'Connected with Google' : 'Connect with Google'}</span>
                  ...
                  <button
                    ...
                    onMouseLeave={(e) => e.currentTarget.style.boxShadow = '0 0 6px rgba(103,103,103,0.35)'}
                  >
                    <span style={{ fontSize: '1rem', fontWeight: 400, letterSpacing: '-0.02em', color: isLinkedInLinked ? '#22C55E' : undefined }}>{isLinkedInLinked ? 'Connected with LinkedIn' : 'Connect with LinkedIn'}</span>
