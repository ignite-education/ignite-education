...
const CourseCard = ({ course }) => {
  ...
  return (
    <Link
      to={`/courses/${slug}`}
      className="group block bg-[#F8F8F8] rounded-xl px-5 py-4"
    >
      <div className="flex items-center justify-between">
        ...
        <div className="bg-white rounded-md flex items-center justify-center" style={{ width: '35px', height: '35px' }}>
          <svg width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-[#EDEDED] group-hover:text-[#EF0B72] transition-colors">
