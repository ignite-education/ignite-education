...
const BlogCard = ({ post, className = '', onClick = null }) => {
  ...
  const cardContent = (
    <div className={className}>
      ...
      >
        {featured_image && (
          <div className="w-full" style={{ height: '400px', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <img
              src={featured_image}
              alt={title}
        ...
        <div className="p-4 bg-white rounded-b-md flex items-center justify-between">
          <div className="flex-1 pr-3">
            <h3 className="font-medium text-gray-900 line-clamp-2" style={{ fontSize: '1.21rem', marginBottom: '0.175rem' }}>
              {title}
            </h3>
