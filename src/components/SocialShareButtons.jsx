...
/**
 * SocialShareButtons - Lazy-loaded social sharing component
 * Defers loading of share buttons that are below the fold
 */
const SocialShareButtons = memo(({ courseSlug, courseTitle, copied, onCopy }) => {
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      {/* X (Twitter) */}
      <a
        href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(shareUrl)}&text=${encodeURIComponent(courseTitle)}`}
        target="_blank"
        rel="noopener noreferrer"
