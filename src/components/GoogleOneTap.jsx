 ...
 * Stores courseSlug in sessionStorage for post-auth enrollment in ProgressHub
 */
const GoogleOneTap = ({ courseSlug }) => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      // Store course slug for post-auth enrollment (handled in ProgressHub)
        ...
        {error ? (
          <div className="text-center">
            ...
            <button
              ...
              disabled={isLoading}
              className="px-4 py-2 bg-[#EF0B72] text-white rounded-lg hover:bg-[#d10a66] transition-colors disabled:opacity-50"
            >
              Try Again
            </button>
          </div>
