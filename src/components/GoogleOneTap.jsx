      ...
      {error ? (
        ...
        <div className="w-full">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 w-full px-4 bg-white rounded-md hover:bg-gray-50 transition-colors disabled:opacity-50 mb-3 shadow-[0_0_10px_rgba(103,103,103,0.25)]"
            style={{ paddingTop: '0.575rem', paddingBottom: '0.575rem', borderRadius: '6px' }}
          >
            {loadingProvider === 'google' ? (
              <div className="w-5 h-5 border-2 border-gray-300 border-t-gray-600 rounded-full animate-spin" />
            ) : (
              <>
                <span className="text-[0.9rem] text-black font-medium truncate" style={{ letterSpacing: '-0.02em' }}>
          ...
          <button
            ...
            disabled={loadingProvider}
            className="flex items-center justify-center gap-2 w-full px-4 bg-white rounded-md hover:bg-gray-50 transition-colors disabled:opacity-50 mb-4 shadow-[0_0_10px_rgba(103,103,103,0.25)]"
            style={{ paddingTop: '0.575rem', paddingBottom: '0.575rem', borderRadius: '6px' }}
          >
            {loadingProvider === 'linkedin_oidc' ? (
              ...
              <>
                <span className="text-[0.95rem] text-black font-medium truncate" style={{ letterSpacing: '-0.02em' }}>
