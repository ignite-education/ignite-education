        ...
        <div className="w-full">
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3.5 py-1.5 rounded-md border transition-colors ${
                copied
            ...
            <button
              ...
              className="w-9 h-9 flex items-center justify-center rounded-md bg-[#0A66C2] hover:bg-[#004182] transition-colors"
            >
            ...
            <button
              ...
              className="w-9 h-9 flex items-center justify-center rounded-md bg-[#25D366] hover:bg-[#1DA851] transition-colors"
            >
              <svg className="w-[18px] h-[18px]" viewBox="0 0 24 24" fill="white">
            ...
            <button
              ...
              className="w-9 h-9 flex items-center justify-center rounded-md bg-[#FF6719] hover:bg-[#E55A14] transition-colors"
            >
              <svg className="w-[18px] h-[18px]" viewBox="0 0 24 24" fill="white">
