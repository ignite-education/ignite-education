...
const LLM_LOGOS: Record<string, React.ReactNode> = {
  'Claude': (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
      <path d="M4.709 15.955l4.72-2.756.08-.08 2.007-5.199-1.152-.04L4.709 15.96zm8.837-4.235L9.324 6.798l-.959 2.487 5.18 2.435zM16.6 8.12l-5.27 1.904 4.222 4.922L16.6 8.12zm-4.522 7.79l5.341-1.98-4.383-5.103-.958 7.083zm4.8-9.622L12.86 4.41l-2.156 5.604 6.174-3.726zM7.003 17.1l7.2-2.623L9.6 9.21 7.003 17.1zM12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0z"/>
    </svg>
  ),
  'ChatGPT': (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
  ...
  'Co-Pilot': (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
      <path d="M23.922 12.397c-.04.463-.135.919-.284 1.358a4.473 4.473 0 0 1-1.423 2.09 4.724 4.724 0 0 1-1.595.897c-.473.168-.965.28-1.466.33a8.873 8.873 0 0 1-.92.042H5.78a8.874 8.874 0 0 1-.92-.042 6.2 6.2 0 0 1-1.467-.33 4.723 4.723 0 0 1-1.594-.897A4.473 4.473 0 0 1 .375 13.755 4.868 4.868 0 0 1 .09 12.397a5.036 5.036 0 0 1 .063-1.382 4.66 4.66 0 0 1 .582-1.516 7.39 7.39 0 0 1 .665-.89c.24-.28.497-.545.768-.793a11.373 11.373 0 0 1 1.768-1.315 12.07 12.07 0 0 1 1.97-.997 10.834 10.834 0 0 1 2.126-.595A9.934 9.934 0 0 1 10.24 4.8h3.519c.739.031 1.473.133 2.191.303a10.85 10.85 0 0 1 2.12.596c.681.27 1.332.607 1.946.998a11.39 11.39 0 0 1 1.769 1.315c.27.247.527.513.768.793.243.278.464.575.66.89.29.466.483.98.568 1.516a5.04 5.04 0 0 1 .063 1.382zM12 7.2a5.856 5.856 0 0 0-2.859.74 5.876 5.876 0 0 0-2.14 2.018 4.238 4.238 0 0 0-.55 1.149 3.614 3.614 0 0 0-.148 1.29c.023.283.085.561.183.826.144.4.379.76.69 1.053a2.472 2.472 0 0 0 1.723.653h6.202a2.472 2.472 0 0 0 1.723-.653c.311-.293.546-.654.69-1.053.098-.265.16-.543.183-.826a3.614 3.614 0 0 0-.148-1.29 4.237 4.237 0 0 0-.55-1.149 5.876 5.876 0 0 0-2.14-2.019A5.856 5.856 0 0 0 12 7.2z"/>
    </svg>
  ),
  'Gemini': (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 0C9.284 3.478 6.442 6.139 3.478 8.535 6.442 10.931 9.284 13.592 12 17.07c2.716-3.478 5.558-6.139 8.522-8.535C17.558 6.139 14.716 3.478 12 0zm0 6.93c2.716 3.478 5.558 6.139 8.522 8.535C17.558 17.861 14.716 20.522 12 24c-2.716-3.478-5.558-6.139-8.522-8.535C6.442 13.069 9.284 10.408 12 6.93z"/>
    </svg>
  ),
}
