      ...
      <div className="max-w-[1330px] mx-auto px-6">
        ...
        <div className="mb-5">
          ...
          <div className="flex items-center justify-center gap-3 mx-auto px-6">
            ...
            >
              <svg width="18.7" height="18.7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-black group-hover/create:text-[#EF0B72] transition-colors duration-300">
