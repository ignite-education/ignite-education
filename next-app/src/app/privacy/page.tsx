...
export default function PrivacyPage() {
  const breadcrumbData = generateStaticPageBreadcrumb('Privacy Policy', '/privacy')
      ...
      <div className="bg-white">
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <section>
            ...
            <p className="mb-4">
              Welcome to Ignite Education (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;). We operate the website ignite.education (the &ldquo;Website&rdquo;), which provides product management courses and educational resources.
            </p>
            <p className="mb-4">
