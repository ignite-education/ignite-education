...
export default function CourseRequestModal({ courseName, onClose, initialPhase = 'sign-in', initialUserName }: CourseRequestModalProps) {
  ...
  // Handle Google button click (first-time users use popup OAuth, returning users use One Tap)
            ...
            <>
              ...
              <div className="space-y-2">
                {googleHint ? (
                  ...
                  /* Custom Google button (for first-time users) — uses popup OAuth instead of GIS iframe */
                  <button
