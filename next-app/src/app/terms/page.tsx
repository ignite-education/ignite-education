...
export default function TermsPage() {
  const breadcrumbData = generateStaticPageBreadcrumb('Terms of Service', '/terms')
      ...
      <div className="bg-white">
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <section>
            ...
            <p className="mb-4">
              Welcome to Ignite (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;). These Terms of Service (&ldquo;Terms&rdquo;) govern your access to and use of the Ignite learning platform, including our website, courses, materials, and related services (collectively, the &ldquo;Service&rdquo;).
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              Your privacy is important to us. Our collection and use of personal information is governed by our <Link href="/privacy" className="text-[#EF0B72] hover:underline">Privacy Policy</Link>, which is incorporated into these Terms by reference. By using the Service, you consent to our collection and use of personal data as outlined in the Privacy Policy.
            </p>
          </section>
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold mb-3">9.1 Service Provided &ldquo;As Is&rdquo;</h3>
            <p className="mb-4">
          ...
          <section>
            ...
            <p>
              We reserve the right to modify these Terms at any time. We will notify users of material changes by posting the updated Terms on our website and updating the &ldquo;Last Updated&rdquo; date. Your continued use of the Service after changes become effective constitutes acceptance of the modified Terms.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              These Terms, together with our <Link href="/privacy" className="text-[#EF0B72] hover:underline">Privacy Policy</Link> and any other legal notices published by us on the Service, constitute the entire agreement between you and Ignite concerning the Service.
            </p>
          </section>
