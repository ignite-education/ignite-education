  ...
  return e(Html, null,
    ...
    e(Body, { style: main },
      e(Container, { style: container },
        ...
        // Header
        e(Heading, { style: h1 },
          e('span', { style: { color: '#000000' } }, "We're sorry to see you go, "),
        ...
        e(Section, { style: contentSection, className: 'content-section' },
          e(Text, { style: introTitle }, 'Your subscription has been cancelled'),
          e(Text, { style: introText },
            "You'll continue to have access to premium features until the end of your current billing period. After that, you can still access all course content - you'll just see ads while learning."
          ),
          // Stats Box
