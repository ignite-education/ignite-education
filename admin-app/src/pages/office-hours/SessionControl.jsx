...
const SessionControl = ({ activeSession, elapsed, starting, ending, onGoLive, onEndSession, formatDuration }) => {
  if (!activeSession) {
    return (
      <div className="p-6 rounded-xl border border-gray-200 bg-gray-50 text-center py-8">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            disabled={ending}
            className="flex items-center gap-2 px-3 py-2 bg-red-500/10 hover:bg-red-500/20 text-red-600 rounded-lg text-sm font-medium transition-colors"
          >
            <VideoOff size={14} />
