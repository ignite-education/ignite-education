                  ...
                  <table className="w-full">
                    <thead className="bg-white">
                      <tr>
                        ...
                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase">Public Page</th>
                        ...
                        filteredUsers.map((user) => {
                          ...
                          return (
                            <tr key={user.id} className={`hover:bg-gray-100 ${isCurrentUser ? 'bg-pink-100 border-l-4 border-pink-500' : ''}`}>
                              ...
                              {/* Public profile at ignite.education/{username}. The slug is
                                  generated by a DB trigger at signup; "Not generated" means
                                  that row predates the trigger — see
                                  migrations/fix_username_on_signup.sql. */}
                              <td className="px-6 py-4 text-sm">
                                {user.username ? (
                                  <a
                                    ...
                                    className={`inline-flex items-center gap-1.5 font-medium hover:underline ${
                                      user.is_public === false ? 'text-gray-500' : 'text-blue-600'
                                    }`}
                                    title={
                                  ...
                                  >
                                    {user.is_public === false ? <EyeOff size={14} /> : <ExternalLink size={14} />}
                                    /{user.username}
                                  </a>
                                ) : (
